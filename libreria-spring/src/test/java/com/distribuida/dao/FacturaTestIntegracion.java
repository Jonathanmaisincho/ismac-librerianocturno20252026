...
@Test
    public void testFacturaSave(){
        ...
        Factura facturaGuardado = facturaRepository.save(factura);
        assertNotNull(facturaGuardado);
        assertEquals("FAC-00066", facturaGuardado.getNumFactura());
        assertEquals(100.00, facturaGuardado.getTotalNeto());



}

@Test public void testFacturaUpdate() {
    ...
    Factura facturaActualizado= facturaRepository.save(factura.orElse(null));

    assertNotNull(facturaActualizado);
    assertEquals("FAC-00077", facturaActualizado.getNumFactura());
    assertEquals(260.00, facturaActualizado.getTotal());
